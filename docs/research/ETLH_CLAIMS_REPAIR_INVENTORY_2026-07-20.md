...
| `/blog/sustainable-tiny-living-room-layout-ideas` | **Unrepaired; requires claims narrowing** | Broad “bigger,” cozy, sustainable-material, durability, plant-air, and universal-layout language remains. Lower priority than the selected article because it lacks the selected article’s stale asset mismatch and its highest-risk claim is already isolated in the inventory. |
...
| `/blog/sustainable-small-apartment-decor-before-after` | **Unrepaired; requires owner decision or verified evidence** | Real before/after, under-$300, 30% bigger, and firsthand “we” claims require provenance. Do not silently convert the case study without recording the positioning consequence. |
...
| `/blog/zero-waste-pantry-organization-small-apartments` | **Fully repaired** | PR #79; practical walkthrough and food-safety boundaries recorded. |
| `/blog/low-waste-kitchen-tips-chef-habits` | **Fully repaired** | PR #81; chef authority and food-use claims bounded with authoritative safety limits. |
| `/blog/zero-waste-kitchen-budget-9-swaps` | **Fully repaired** | PR #80; budget, replacement, safety, and environmental claims repaired. |
| `/blog/small-apartment-eco-upgrade-checklist` | **Fully repaired** | PR #82; fixed-budget and pacing claims repaired. |
| `/blog/zero-waste-kitchen-ideas-tiny-apartments` | **Fully repaired** | PR #78; composting troubleshooting scope and local/authoritative boundaries verified. |
