...
export function SiteHeader() {
  ...
  return (
    <nav className="sticky top-0 z-50 bg-earth-100/90 backdrop-blur-md border-b border-earth-900/5">
      ...
      {open && (
        <div className="md:hidden border-t border-earth-900/5 bg-earth-100">
