...
const description =
  "Questions or topic suggestions for Eco Tiny Living Hub? Email hello@ecotinylivinghub.com or connect through Instagram.";
    ...
    <div className="min-h-screen bg-earth-100 text-earth-900">
      ...
      <main className="max-w-2xl mx-auto px-6 py-16 md:py-24">
        ...
        <p className="text-earth-900/70 mt-4 text-lg leading-relaxed">
          Have a question about sustainable small-space living, a correction, or a topic you would
          like to see covered? Email is the most reliable way to reach Eco Tiny Living Hub.
        </p>
        ...
        <section className="mt-12 bg-white border border-earth-900/5 rounded-2xl p-8">
          ...
          <p className="text-earth-900/70 mt-3 leading-relaxed">
            ...
            <a
              ...
              onClick={() =>
                trackAnalyticsEvent("contact_email_click", { link_location: "contact_copy" })
              }
            >
              {contactEmail}
            </a>
          ...
          <a
            href={`mailto:${contactEmail}`}
            onClick={() =>
              trackAnalyticsEvent("contact_email_click", { link_location: "contact_button" })
            }
